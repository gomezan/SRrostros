...
from pruebaModelos.LESRCNN.lesrcnn_b.dataset import TestDataset
from PIL import Image
import cv2 #201904111751tcw
def parse_args():
    model = "lesrcnn"
    test_data = r"C:\Users\Estudiante\Documents\DIV2K\DIV2K_train"
    ckpt = r"C:\Users\Estudiante\Documents\GitHub\SRrostros\pruebaModelos\pruebaModelos\LESRCNN\lesrcnn_b\lesrcnn.pth"
    sample_dir = r"C:\Users\Estudiante\Documents\DIV2K\resultadoFinal"
...
def sample(net, device, dataset, cfg):
    ...
    print (mean_psnr2,  mean_ssim)
        #print '-------------------'z
def main(cfg):
    module = importlib.import_module("pruebaModelos.LESRCNN.lesrcnn_b.model.{}".format(cfg.model))
